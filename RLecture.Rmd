---
title: "Data Open Lecture: An Introduction of R"
author: "Fangda Fan"
date: "Dec 2016"
output: 
  slidy_presentation:
    footer: "for the earth shall be full of the knowledge of the LORD as the waters cover the sea. (Isaiah 11:9 ESV)"
---
...
4. Data Operation
5. Network Analysis
6. R Introduction Review

# Lecture 1. Numerical R

## Preparation
	
- Bring your laptop.
- Install [R](https://cloud.r-project.org/) *and* [R-studio](https://www.rstudio.com/products/rstudio/download/)
- Download the dataset "[Diamonds.csv](https://github.com/founderfan/Data-Open-Lecture)"
...
# 1.3 Matrix, List and Data Frame
## Matrix (1)
...
# 3.2 Plots for Different Variable Types
...
# Lecture 4. Data Operation
## Preparation

- Download the [dataset](https://github.com/founderfan/Data-Open-Lecture) "Diamonds.csv"
...
kable(data.frame(Variable_Issue = c("Non-numeric", "Sparsity", "Collinearity", "Missing values", "Distribution Bias"), Example = c("a,b,c,d", "1,1,1,1", "1,2,3,4; 2,4,6,8", "1,NA,3,NA", "1,2,3,1000"), Model_Effect = c("Error", "Noise", "Robust loss", "Error", "Robust loss"), Test = c("Data Type", "Count Frequency", "Correlation Matrix", "Count NAs", "Numeric Statistics")))
```
...
- Download the dataset "[Rlecture_data_facebook.txt](https://github.com/founderfan/Data-Open-Lecture)"
...
# Lecture 6. R Introduction Review
...
```{r, warning = F, message = F, echo = F}
kable(data.frame(R = c("i", "j", "by"), ggplot2 = c("", "aes(x, y)", "aes(color/fill/...)"), SQL = c("WHERE", "SELECT", "GROUP BY")))
```
